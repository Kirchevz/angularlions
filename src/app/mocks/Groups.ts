...
export let GROUPS: Group[] = [
        ...
        members: [
            {
                ...
                tenantWebInfo: {CompanyId: 1, DepartmentId: 1, LeaseId: 1}
            },
            {
                id: 2,
    ...
    {
        id: 2, name: "SecondGroup", jid: "nadeemo.Secundo@conference.localhost", departmentId: 1, channels: [
    ...
    {
        id: 3, name: "ThirdGroup", jid: "nadeemo.Thirdo@conference.localhost", departmentId: 1, channels: [
            { id:2, name: "general", jid: "nadeemo.Thirdo.general@conference.localhost"}
        ],  members: []
    }
